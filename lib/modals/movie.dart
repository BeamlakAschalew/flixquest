...
class MovieGenresLis {
  List<MovieGenres>? genre;

  MovieGenresLis({
    this.genre,
  });

  MovieGenresLis.fromJson(Map<String, dynamic> json) {
    if (json['genres'] != null) {
      genre = [];
      json['genres'].forEach((v) {
        genre?.add(MovieGenres.fromJson(v));
      });
    }
  }
...
class MovieGenres {
  String? genreName;
  int? genreID;
  MovieGenres({this.genreName, this.genreID});
...
class FullMovieDetails {
  ...
  List<PersonImages>? personImages;
  List<Stills>? stills;
  ...
  FullMovieDetails.fromJson(Map<String, dynamic> json) {
    ...
    if (json['credits']['guest_stars'] != null) {
      episodeGuestStars = [];
      json['credits']['cast'].forEach((v) {
        episodeGuestStars?.add(TVEpisodeGuestStars.fromJson(v));
      });
    }
    if (json['images']['backdrops'] != null) {
      backdrops = [];
